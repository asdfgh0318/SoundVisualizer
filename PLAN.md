...
- **Capture bookkeeping to explain:** why the PWM-1800 WAVs are 0.2–1.8 s long in nine of twelve runs, why PWM 1200 never spins up a tone, and why prop18's PWM-2000 step did not spin up (1.9 A at 11.9 V). prop7's different speed is explained: the supply was current-limiting at 8 V.
