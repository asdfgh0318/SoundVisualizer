...
0. **Repeatability, day 3 (2026-09-25).** Nothing touched overnight. Two back-to-back runs agree to
   ...
   **Stuffing the corner near the capsule hubs** (`corner-stuffed`): map moved 0.43 dB, level unchanged
   above 400 Hz (so the boost above stays); 250–400 Hz worse (1.60 → 1.86), 5–6.4 kHz better
   (1.10 → 0.87), total 1.403 → 1.445. Figure: `corner-stuffed-day3.pdf`.
   **One-layer folding screen** (`screen-1-layer`): map moved 1.21 dB, most on the lower half of the arc
   (−18° to −90°, 1.3–1.8 dB); 250–400 Hz better (1.86 → 1.52) but 630 Hz–3 kHz worse and 5–6.4 kHz much
   worse (0.87 → 2.39); total 1.445 → 1.626. Level +0.44 dB at 5–6.4 kHz on top of the earlier
   boost. Figure: `screen-1-layer-day3.pdf`.
   **Felt on a wall** (`felt-wall`, screen down again; compared with `corner-stuffed`): map moved 0.95 dB;
   ...
   **1.427, not back to 1.303–1.314.** The level stays +0.4–0.7 dB above `cleanup-2` at every frequency
   ...
   first-reflection zone — not along the walls. Figure: `carpet-square-day3.pdf`. **Wall insulation removed
   ...
   **Thin carpet on standoffs** (`thin-carpet-raised`; the +54° capsule had been unplugged at 17:56 and
   ...
   thin → thick gained 0.20 dB, thick → thicker 0.08. Figure: `thicker-carpet-raised-day3.pdf`. **Full
