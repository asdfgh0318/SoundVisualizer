...
plane. The −90° mic serial is not yet known.
...
Notes:
- Order was given top-down (+90 → −72); −90 to be filled in once that mic's serial is read.
...
1. In a normal browser tab, open <https://www.minidsp.com/products/acoustic-measurement/umik-2> → **Unique Calibration File Download**. Enter each serial (with dash, e.g. `810-8897`), submit; it downloads `<serial>.txt` + `<serial>_90deg.txt`.
   Serials: `811-1897 811-1892 810-8901 810-8893 811-2321 810-8897 811-2310 810-8900 810-8903 811-1896`
